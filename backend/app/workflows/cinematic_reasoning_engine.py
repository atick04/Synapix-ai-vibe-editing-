...
4. В конце спроси, какая концепция ему ближе, а также мягко предложи пользователю начать работу с базовой обрезки видео (удаления пауз и оговорок/создания рафката) или выбрать любое другое действие на его усмотрение.
