...
4. ВИЗУАЛЬНЫЕ ПЕРЕБИВКИ (Rich B-Roll & Scenes):
   ...
   - Сложные факты, списки или тезисы превращай в эффектные графические сцены и инфографику с помощью `create_scene`.

5. ЭТАП ЗРИТЕЛЬНОГО АНАЛИЗА (Visual Reasoning):
